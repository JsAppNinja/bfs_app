...
#pragma warning restore 0109
		...
		///<summary>
		/// Email Html Template: Email Template for HTML view (Razor Enabled)
		///</summary>
		[ImplementPropertyType("emailHtmlTemplate")]
		public string EmailHtmlTemplate
		{
			get { return this.GetPropertyValue<string>("emailHtmlTemplate"); }
		}

		///<summary>
		/// Email PlainText Template: Email template in plain text if needed for alternate view.  (Razor Enabled)
		///</summary>
		[ImplementPropertyType("emailPlainTextTemplate")]
		public string EmailPlainTextTemplate
		{
			get { return this.GetPropertyValue<string>("emailPlainTextTemplate"); }
		}
