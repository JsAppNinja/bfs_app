...
{
	// Mixin content Type 1294 with alias "careerIntroControls"
	/// <summary>Career Intro Controls</summary>
	public partial interface ICareerIntroControls : IPublishedContent
	{
		...
		IPublishedContent CareerSubMenu1Image { get; }
		...
		IPublishedContent CareerSubMenu2Image { get; }
		...
		IPublishedContent CareerSubMenu3Image { get; }
		...
		IPublishedContent CareerSubMenu4Image { get; }
		...
		IPublishedContent CareerSubMenu5Image { get; }
	...
	/// <summary>Career Intro Controls</summary>
	[PublishedContentModel("careerIntroControls")]
	public partial class CareerIntroControls : PublishedContentModel, ICareerIntroControls
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "careerIntroControls";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public CareerIntroControls(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<CareerIntroControls, TValue>> selector)
		{
		...
		public static IHtmlString GetCareerIntroParagraph1(ICareerIntroControls that) { return that.GetPropertyValue<IHtmlString>("careerIntroParagraph1"); }
		...
		public static IHtmlString GetCareerIntroParagraph2(ICareerIntroControls that) { return that.GetPropertyValue<IHtmlString>("careerIntroParagraph2"); }
		...
		public static IPublishedContent GetCareerSubMenu1Image(ICareerIntroControls that) { return that.GetPropertyValue<IPublishedContent>("careerSubMenu1Image"); }
		...
		public static Umbraco.Web.Models.RelatedLinks GetCareerSubMenu1Link(ICareerIntroControls that) { return that.GetPropertyValue<Umbraco.Web.Models.RelatedLinks>("careerSubMenu1Link"); }
		...
		public static string GetCareerSubMenu1Text(ICareerIntroControls that) { return that.GetPropertyValue<string>("careerSubMenu1Text"); }
		...
		public static IPublishedContent GetCareerSubMenu2Image(ICareerIntroControls that) { return that.GetPropertyValue<IPublishedContent>("careerSubMenu2Image"); }
		...
		public static Umbraco.Web.Models.RelatedLinks GetCareerSubMenu2Link(ICareerIntroControls that) { return that.GetPropertyValue<Umbraco.Web.Models.RelatedLinks>("careerSubMenu2Link"); }
		...
		public static string GetCareerSubMenu2Text(ICareerIntroControls that) { return that.GetPropertyValue<string>("careerSubMenu2Text"); }
		...
		public static IPublishedContent GetCareerSubMenu3Image(ICareerIntroControls that) { return that.GetPropertyValue<IPublishedContent>("careerSubMenu3Image"); }
		...
		public static Umbraco.Web.Models.RelatedLinks GetCareerSubMenu3Link(ICareerIntroControls that) { return that.GetPropertyValue<Umbraco.Web.Models.RelatedLinks>("careerSubMenu3Link"); }
		...
		public static string GetCareerSubMenu3Text(ICareerIntroControls that) { return that.GetPropertyValue<string>("careerSubMenu3Text"); }
		...
		public static IPublishedContent GetCareerSubMenu4Image(ICareerIntroControls that) { return that.GetPropertyValue<IPublishedContent>("careerSubMenu4Image"); }
		...
		public static Umbraco.Web.Models.RelatedLinks GetCareerSubMenu4Link(ICareerIntroControls that) { return that.GetPropertyValue<Umbraco.Web.Models.RelatedLinks>("careerSubMenu4Link"); }
		...
		public static string GetCareerSubMenu4Text(ICareerIntroControls that) { return that.GetPropertyValue<string>("careerSubMenu4Text"); }
		...
		public static IPublishedContent GetCareerSubMenu5Image(ICareerIntroControls that) { return that.GetPropertyValue<IPublishedContent>("careerSubMenu5Image"); }
		...
		public static Umbraco.Web.Models.RelatedLinks GetCareerSubMenu5Link(ICareerIntroControls that) { return that.GetPropertyValue<Umbraco.Web.Models.RelatedLinks>("careerSubMenu5Link"); }
		...
		public static string GetCareerSubMenu5Text(ICareerIntroControls that) { return that.GetPropertyValue<string>("careerSubMenu5Text"); }
	}
}
