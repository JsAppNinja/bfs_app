...
namespace CustomerPortalCMS.Models.UI
{
    public class AggregateResult
    {
        ...
        public object Value
        {
            get { return this.aggregateValue; }
            internal set { this.aggregateValue = value; }
        }

        public string Member
        {
            get { return this.function.SourceField; }
        }
        ...
        public object FormattedValue
        {
            get
            {
                ...
                return (object) string.Format((IFormatProvider) CultureInfo.CurrentCulture,
                    this.function.ResultFormatString, new object[1]
                    {
                        this.aggregateValue
                    });
            }
        ...
        {
            get { return this.function.Caption; }
        }
        ...
        {
            get { return this.function.FunctionName; }
        }

        public string AggregateMethodName
        {
            get { return this.function.AggregateMethodName; }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="T:AggregateResult" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="T:AggregateResult" /> class.
        /// </summary>
        /// <param name="function"><see cref="T:AggregateFunction" /> that generated the result.</param>
        /// <exception cref="T:System.ArgumentNullException"><c>function</c> is null.</exception>
