...
class DashboardComponent extends Component {
    ...
    componentDidUpdate() {
        if (this.props.refreshStore && this.props.refreshStore.length !== this.state.refreshStores.length) {
    ...
    addPlayListener() {
        // let captions = document.getElementsByClassName('videocaption');
        // if (captions && captions.length) {
        //     let self = this
        //     for (let i = 0; i < captions.length; i++) {
        //         let image = document.createElement('img');
        //         image.classList.add("play-header-btn");
        //         image.src = playBtn
        //         captions[i].appendChild(image);
        //         captions[i].insertBefore(image, captions[i].childNodes[0]);
        //         captions[i].childNodes[0].addEventListener('click', function () {
        //             let index = parseInt(captions[i].classList[1])
        //             self.selectVideo(index)
    ...
    selectVideo(index) {
        ...
        element[0].children[2].classList.remove("animated");
        element[0].children[2].classList.remove("fadeInUp");
        if (index !== this.state.videoIndex) {
            var imgelement = document.getElementsByClassName("active");
            var videoelement = document.getElementsByClassName("active");
            imgelement[0].children[0].classList.remove("hideele");
            imgelement[0].children[0].classList.add("showele");
            videoelement[0].children[1].classList.remove("showele");
            videoelement[0].children[1].classList.add("hideele");
            ...
            this.setState({ videoIndex: index, isPlaying: false, paused: true, pausedonmobile: true, autoSlide: true, clicked: true })
        } else {
            imgelement = document.getElementsByClassName("active");
            videoelement = document.getElementsByClassName("active");
            imgelement[0].children[0].classList.remove("showele");
            imgelement[0].children[0].classList.add("hideele");
            videoelement[0].children[1].classList.remove("hideele");
            videoelement[0].children[1].classList.add("showele");
            titleelement = document.getElementsByClassName("vm-layout");
            if (titleelement && titleelement.length)
                titleelement[0].classList.add("d-none");
            this.setState({ videoIndex: index, isPlaying: !this.state.isPlaying, paused: !this.state.paused, pausedonmobile: !this.state.pausedonmobile, autoSlide: false });
        }
    }
    ...
    */
    toggleSliderOnMobile() {
        this.selectVideo(this.state.videoIndex, this.state.paused)
    ...
    */
    previous() {
        const nextIndex = this.state.videoIndex === 0 ? videos.length - 1 : this.state.videoIndex - 1;
        this.setState({ pausedonmobile: true, videoIndex: nextIndex, paused: true });
        mobiletitle = allvideos[this.state.videoIndex].videoLabel
        var imgelement = document.getElementsByClassName("imagepart");
        var videoelement = document.getElementsByClassName("videopart");
    ...
    */
    showText() {
        var element = document.getElementsByClassName("active");
        if (this.state.isPlaying === false && element && element.length && element[0].children.length && element[0].children[2]) {
            // console.log(     element[0].children[2])
            element[0].children[2].classList.add("animated");
            element[0].children[2].classList.add("fadeInUp");
            this.setState({
                autoSlide: false
            })
        }
    ...
    */
    hideText() {
        var element = document.getElementsByClassName("active");
        if (element && element.length && element[0].children.length && element[0].children[2]) {
            element[0].children[2].classList.remove("animated");
            element[0].children[2].classList.remove("fadeInUp");
            this.setState({
                autoSlide: true
    ...
    */
    manageTextStyles() {
        ...
        for (var i = 0; i < myMobileElements.length; i++) {
            myMobileElements[i].childNodes[0].childNodes[1].style.color = this.props.homeData[0].imageTextFontColor;

            if (this.props.homeData[0].imageTextVerticalPosition) {
                if (this.props.homeData[0].imageTextVerticalPosition.toLowerCase() === "top") {
                    myMobileElements[i].style.top = 0;
                } else if (this.props.homeData[0].imageTextVerticalPosition.toLowerCase() === "bottom") {
            ...
            } else if (this.props.homeData[0].imageTextHorizontalPosition && this.props.homeData[0].imageTextHorizontalPosition.toLowerCase() === "middle") {
            ...
            if (this.props.homeData[0].imageTextFontSizeMobile) {
                myMobileElements[i].childNodes[0].childNodes[1].style.fontSize = this.props.homeData[0].imageTextFontSizeMobile ? this.props.homeData[0].imageTextFontSizeMobile + "px" : "";
            }
        }
    }
    ...
    render() {
        ...
        if (this.props.homeData.length > 0) {
            image1 = baseurl + this.props.homeData[0].feature1VideoImage;
            ...
            videos.push(
                {
                    ...
                    responsive: true,
                    image: slider1,
                    featureImage: this.props.homeData[0].feature1VideoImage ? baseurl + this.props.homeData[0].feature1VideoImage : slider1
                ...
                },
                {
                    ...
                    responsive: true,
                    image: slider2,
                    featureImage: this.props.homeData[0].feature2VideoImage ? baseurl + this.props.homeData[0].feature2VideoImage : slider2
                ...
                },
                {
                    ...
                    responsive: true,
                    image: slider3,
                    featureImage: this.props.homeData[0].feature3VideoImage ? baseurl + this.props.homeData[0].feature3VideoImage : slider3
                ...
                },
                {
                    ...
                    responsive: true,
                    image: slider4,
                    featureImage: this.props.homeData[0].feature4VideoImage ? baseurl + this.props.homeData[0].feature4VideoImage : slider4
            ...
            dashdata["featurethumbnail1"] = this.props.homeData[0].feature1Thumbnail ? baseurl + this.props.homeData[0].feature1Thumbnail : weAre;
            dashdata["featurethumbnail2"] = this.props.homeData[0].feature2Thumbnail ? baseurl + this.props.homeData[0].feature2Thumbnail : manufacture;
            dashdata["featurethumbnail3"] = this.props.homeData[0].feature3Thumbnail ? baseurl + this.props.homeData[0].feature3Thumbnail : distribtuition;
            dashdata["featurethumbnail4"] = this.props.homeData[0].feature4Thumbnail ? baseurl + this.props.homeData[0].feature4Thumbnail : Service;
            ...
            for (var i = 0; i < myElements.length; i++) {
                if (this.props.homeData[0].imageTextHorizontalPosition && this.props.homeData[0].imageTextHorizontalPosition.toLowerCase() === "right") {
                    ...
                    myElements[i].classList.add("icon-right-side")
                }

                myElements[i].childNodes[0].style.color = this.props.homeData[0].imageTextFontColor;
                myElements[i].childNodes[0].style.fontSize = this.props.homeData[0].imageTextFontSize ? this.props.homeData[0].imageTextFontSize + "px" : "48px";
                if (this.props.homeData[0].imageTextVerticalPosition) {
                    if (this.props.homeData[0].imageTextVerticalPosition.toLowerCase() === "top") {
        ...
        const slides = allvideos.map((item, i) => {
            return (
                <CarouselItem id={i} key={i} >
                    <div className="imagepart showele">
                        <img className="imagepart showele" src={item.featureImage} alt="sliderimage" />
                        <div className="w-100 h-100 position-absolute  play-button-banner text-center">
                            {this.state.showLoader ? null : <img className="img-fluid play-button-img" src={playBtn} onClick={() => this.selectVideo(i)} alt="playbutton" />}
                        </div>
                    </div>
                    <div className="videopart hideele">
                        <Vimeo
                            ...
                            background={false}
                            showPortrait={false}
                            onLoaded={() => { this.changeOnreadyVideo() }}
                            onCueChange={(e) => { this.vimeoCue(e) }}
                            onPlay={(e) => { this.vimeoPlayed(e) }}
                            muted={false}
                            onEnd={() => { this.videoEnd() }}
                        />

                    </div>
                    <CarouselCaption className={"videocaption " + i} captionText="" captionHeader={item.videoLabel}>
                    </CarouselCaption>
                </CarouselItem>
            );
        });
        ...
        return (
            <div className=" pt-xl-3 bg-gray midcontent">
                <div className="row m-0 bg-gray pb-2 home_slider_mein_sec">
                    <div className="container hme_slider video-option p-0 banneranimate">
                        <div className="home_slid_left">
                            <div className="bannerSlide position-relative" onMouseEnter={() => this.showText()} onMouseLeave={() => this.hideText()}>
                                <img alt="backimage" className="back-image d-none d-md-block" src={image1} />
                                <Carousel
                                ...
                                >
                                    {slides}
                                    <CarouselControl className="mobilePrev" direction="prev" directionText="Previous" onClickHandler={this.previous} />
                                    <CarouselControl className="mobileNext" direction="next" directionText="Next" onClickHandler={this.next} />
                                </Carousel>

                                {this.state.showLoader ? null :
                                    <span className="vdo_icn">
                                        <div className="col-12 p-2 vm-layout" >
                                            <img className="d-inline-block mb-0 align-middle" onClick={() => this.toggleSliderOnMobile()} src={this.state.pausedonmobile ? mplayButton : mpauseButton} alt="playButton" />
                                            <h5 className="align-middle font-weight-bold d-inline-block mb-0 slide_titl">{mobiletitle}</h5>
                                        </div>
                                    </span>}
                            </div>
                        </div>
                    ...
                    <div className="request_quot_mb bg-gray  text-center col-12 mob-xs-1  p-0">
                        <button type="button" onClick={() => this.togglerequestquote()} className="mt-3  btn theme-btn text-uppercase bg-red px-4 py-3 d-inline-block login-blue text-white mb-4 cursor-pointer">Request a quote </button>
                    </div>

                    {this.state.showLoader ? null : (<div className="container  p-0  main-home-slider-mob d-none d-xl-block">
                        <div className="row pt-3 video-space">
                            <div className={this.state.videoIndex === 0 ? "col-12 col-md-3  slide-div shadow-none active " : "col-12 col-md-3 shadow-none   slide-div"} >
                                <div className="vd-option option-shadow">
                                    <img className="img-area" src={dashdata.featurethumbnail1} alt="manufacture" />
                            ...
                            <div className={this.state.videoIndex === 1 ? "col-12 col-md-3  slide-div shadow-none active " : "col-12 col-md-3 shadow-none   slide-div"}>
                                <div className="vd-option option-shadow">
                                    <img className="img-area" src={dashdata.featurethumbnail2} alt="manufacture" />
                            ...
                            <div className={this.state.videoIndex === 2 ? "col-12 col-md-3 shadow-none   slide-div active " : "col-12 col-md-3 shadow-none   slide-div"}>
                                <div className="vd-option option-shadow">
                                    <img className="img-area" src={dashdata.featurethumbnail3} alt="manufacture" />
                                    <div className="position-absolute text-center  text-white video-title w-100">
                            ...
                            <div className={this.state.videoIndex === 3 ? "col-12 col-md-3 shadow-none   slide-div active " : "col-12 col-md-3 shadow-none   slide-div"}>
                                <div className="vd-option option-shadow">
                                    <img className="img-area" src={dashdata.featurethumbnail4} alt="manufacture" />
                                    <div className="position-absolute text-center  text-white video-title w-100">
                ...
                <ContainerComponent document={document} location={window.location} sendQuote={this.sendQuote} quoteData={this.props.quoteData} getData={this.getStoreData} storeData={this.props.storeData} homeData={this.props.homeData} constructionData={this.props.constructiontypeDataHome} />
                ...
                {
                    this.state.showLoader ? (<div className="showloader ">
